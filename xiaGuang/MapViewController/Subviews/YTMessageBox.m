...
//    [_backgroundView addSubview:_titleLable];
    ...
    if (buttonTitle == nil || buttonTitle.length <= 0) {
        ...
        _enterButton.tag = 1;
        [_enterButton setBackgroundImage:[UIImage imageNamed:@"sort_btnOn"] forState:UIControlStateHighlighted];
        [_enterButton setBackgroundImage:[UIImage imageNamed:@"sort_btn"] forState:UIControlStateNormal];
